...
export default function App() {
  ...
  const refreshSelUser = async () => {
    ...
    setSelUser({ ...ud, views:v, byP, totalEarnings, openEarnings, payoutAmount, totalPaid, lastPayout, userPayouts, pendingCount })
  }
  ...
  const loadAllUsers = async () => {
    ...
    const rows = (usersData||[]).map((u) => {
      ...
      return { ...u, views:v, byP, totalEarnings, openEarnings, payoutAmount, totalPaid, lastPayout, userPayouts, pendingCount }
